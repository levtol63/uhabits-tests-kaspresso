...
object ListHabitsSteps {
    ...
    private fun clickDescendantWithClass(cls: Class<*>, count: Int, isLongClick: Boolean): ViewAction {
    ...
    fun pressCheckmarks(habit: String?, count: Int, isLongClick: Boolean = true) {
        ...
        Espresso.onView(
            ...
            clickDescendantWithClass(CheckmarkButtonView::class.java, count, isLongClick)
        )
